...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    ...
    if "SFT/v921" in dataset_name:
        return raw_datasets.SFT921Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "SFT/v916" in dataset_name:
        return raw_datasets.SFT916Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "SFT/v925" in dataset_name:
        return raw_datasets.SFT925Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "SFT/belle" in dataset_name:
        return raw_datasets.SFTBelloDataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "PPO2/v1" in dataset_name:
        return raw_datasets.PPO2v1Dataset(output_path, seed,
                                                    local_rank, dataset_name)      
    elif "RM2/v1" in dataset_name:
        return raw_datasets.RMV5Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "RM2/v2" in dataset_name:
        return raw_datasets.RM2V2Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "RM2/v3" in dataset_name:
        return raw_datasets.RM2V3Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    elif "RM2/v4" in dataset_name:
        return raw_datasets.RM2V4Dataset(output_path, seed,
                                                    local_rank, dataset_name)
    else:
        raise RuntimeError(
