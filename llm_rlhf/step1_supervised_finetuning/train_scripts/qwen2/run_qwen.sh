...
if [ "$OUTPUT" == "" ]; then
    OUTPUT=/share/project/weiyifan/KG_RAG/results/qwen_ckpt/step2_6w_Qwen2-7B
fi
if [ "$ZERO_STAGE" == "" ]; then
    ZERO_STAGE=3
fi
...
deepspeed  main2.py \
    ...
    --model_name_or_path /share/project/weiyifan/KG_RAG/results/qwen_ckpt/step1_6w_Qwen2-7B/epoch-2-22500 \
